...
function initializeVectorMap (selector) {
...
/*  
//Description example to used in react component below:

import React, { useEffect } from 'react';
import { initializeVectorMap } from './mapUtils.js'; // Import the function from external JavaScript file

const MyComponent = () => {
  useEffect(() => {
    initializeVectorMap('#geographic-map-2');
  }, []);
