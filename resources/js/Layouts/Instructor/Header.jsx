            ...
            <div className="topbar d-flex align-items-center">
                    ...
                    <div className="top-menu ms-auto">
                        <ul className="navbar-nav align-items-center gap-1">
                            ...
                            <li className="nav-item dark-mode d-none d-sm-flex">
                                <Link className="nav-link dark-mode-icon"
                                    href="#" onClick={toggleDarkLightMode}>
              ...
              @endphp */}
                    <div className="user-box dropdown px-3">
                        ...
                        >
                            <img
                                src={ instructor.photo ? `../../../../assets/upload/instructor_images/profile_img/${instructor.photo}` : '../../../../assets/upload/sample.png'}
                                className="user-img"
                                alt="user avatar"
                            />
