                    ...
                    <div className="card-header">
                        <div className="d-flex align-items-center">
                            ...
                            <div className="dropdown ms-auto">
                                <Link className="dropdown-toggle dropdown-toggle-nocaret" href="#" data-bs-toggle="dropdown"><i className='bx bx-dots-horizontal-rounded font-22 text-option'></i>
                                </Link>
                                <ul className="dropdown-menu">
                                    <li><Link className="dropdown-item" href="javascript:;">Action</Link>
                                    </li>
                                    <li><Link className="dropdown-item" href="javascript:;">Another action</Link>
                                    </li>
                                    <li>
                                        <hr className="dropdown-divider"/>
                                    </li>
                                    <li><Link className="dropdown-item" href="javascript:;">Something else here</Link>
                                    </li>
                                </ul>
                            </div>
                        </div>
...
Dashboard.layout = (page) => <AdminPanel children={page} />;
