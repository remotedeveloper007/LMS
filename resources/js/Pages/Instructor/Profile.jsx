...
//     setData((values) => ({ ...values, photo: file }));
//   } 
                                    ...
                                    <div className="card-body">
                                        <div className="d-flex flex-column align-items-center text-center">
                                            <img
                                                src={
                                                    instructor.photo
                                                        ? `/assets/upload/instructor_images/profile_img/${instructor.photo}`
                                                        : "../../../../assets/upload/sample.png"
                                                }
                                                alt="Instructor"
...
Profile.layout = (page) => <InstructorPanel children={page} />;
